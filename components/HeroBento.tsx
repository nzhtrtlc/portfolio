export default function HeroBento() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="md:col-span-2 lg:col-span-3 bento-card flex flex-col justify-center p-8 md:p-12 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-md relative overflow-hidden group">
      ...
      <div className="bento-card p-8 rounded-[2rem] bg-gradient-to-br from-primary/10 to-primary/5 border border-white/10 flex flex-col justify-between min-h-[200px] hover:scale-[1.02] transition-transform duration-300">
      ...
      <div className="bento-card p-8 rounded-[2rem] bg-gradient-to-br from-secondary/10 to-secondary/5 border border-white/10 flex flex-col justify-between min-h-[200px] hover:scale-[1.02] transition-transform duration-300">
      ...
      <div className="md:col-span-2 lg:col-span-1 bento-card p-8 rounded-[2rem] bg-white/5 border border-white/10 flex flex-col justify-between min-h-[200px] hover:scale-[1.02] transition-transform duration-300">
